...
# with open('tests/hiro.pdf', 'rb') as f:
#     pdf_bytes = f.read()
...
#     # Save or display preprocessed image for testing
...
# print("Test completed. Check the saved images or the displayed images for results.")
